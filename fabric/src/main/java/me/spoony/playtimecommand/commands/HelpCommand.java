    ...
    public static int execute(CommandContext<CommandSourceStack> context) {
        ...
        Component helpMessage = Component.literal("Playtime Command Help\n")
                ...
                .append(Component.literal("/playtime ")
                        .append(Component.literal("<username>").withStyle(ChatFormatting.DARK_GREEN))
                        .append(Component.literal(" - See another online player's playtime\n")))
                .append(Component.literal("/playtime ")
                        .append(Component.literal("--top").withStyle(ChatFormatting.DARK_GREEN))
                        .append(Component.literal(" - See top 10 online players by playtime\n")))
                .append(Component.literal("/playtime ")
                        .append(Component.literal("--about").withStyle(ChatFormatting.DARK_GREEN))
                        .append(Component.literal(" - See mod information\n")))
                .append(Component.literal("/playtime ")
                        .append(Component.literal("--help").withStyle(ChatFormatting.DARK_GREEN))
                        .append(Component.literal(" - See command usage")));
